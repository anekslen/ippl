...
int main(int argc, char* argv[]){
    ippl::initialize(argc, argv);
    {
        ...
        using SourceField = ippl::Field<vector4_type, dim, ippl::UniformCartesian<scalar, dim>, typename ippl::UniformCartesian<scalar, dim>::DefaultCentering>;
        using EMField = ippl::Field<vector_type, dim, ippl::UniformCartesian<scalar, dim>, typename ippl::UniformCartesian<scalar, dim>::DefaultCentering>;
        ...
        ippl::StandardFDTDSolver<EMField, SourceField, ippl::absorbing> sfdsolver(source, E, B);

        // Set boundary conditions
        sfdsolver.setPeriodicBoundaryConditions();

        // Initialize the source field with a Gaussian distribution in the z-direction and zeros in the x and y directions
