...
namespace ippl {
    ...
    public:
        ...
        /**
         * @brief Gather field data from cell centers into the particle attribute.
         *
        ...
        /**
         * @brief Gather field data from Nodes into the particle attribute.
         *
         * This function gathers data from the given field into the particle attribute
         * by iterating over all particles. Depending on the parameter @p addToAttribute,
         * the gathered field value is either added to the existing attribute value (using "+=")
         ...
         */
        template <typename Field, typename P2>
        void gatherFromNodes(Field& f, const ParticleAttrib<Vector<P2, Field::dim>, Properties...>& pp, 
                    const bool addToAttribute = false);
    ...
    private:
        template <typename Field, typename P2>
        void gatherCommon(Field& f, const ParticleAttrib<Vector<P2, Field::dim>, Properties...>& pp,
                    const typename Field::Mesh_t::vector_type::value_type offset, const bool addToAttribute = false);
