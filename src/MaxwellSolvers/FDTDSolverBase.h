...
namespace ippl {
    ...
    protected:
        ...
        /**
         * @brief Function to get view of the A field at the current time step.
         */
        auto getAView();
        
                /**
                 * @brief Function to get view of the A field at the next time step.
                 */
                auto getANextView();

        /**
         * @brief Function to get view of the A field at the previous time step.
         */
        auto getAPrevView();
    };
}   // namespace ippl
