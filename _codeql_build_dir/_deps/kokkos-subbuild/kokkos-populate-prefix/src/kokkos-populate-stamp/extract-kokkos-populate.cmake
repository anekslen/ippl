...
#
get_filename_component(filename "/home/runner/work/ippl/ippl/_codeql_build_dir/_deps/kokkos-subbuild/kokkos-populate-prefix/src/4.5.00.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/runner/work/ippl/ippl/_codeql_build_dir/_deps/kokkos-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-kokkos-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-kokkos-populate${i}")
